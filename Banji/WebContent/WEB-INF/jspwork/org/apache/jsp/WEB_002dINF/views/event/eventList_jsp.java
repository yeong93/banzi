 ...
 * Generated at: 2020-08-07 00:07:24 UTC
...
public final class eventList_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser != null && loginUser.getUserId().equals("master")){ 
      ...
      out.write("\t\t\t\t<li class=\"on\"><a href=\"eventList.do?type=1\">진행중 이벤트</a></li>\r\n");
      out.write("\t\t\t\t<li><a href=\"pastList.do?type=2\">종료된 이벤트</a></li>\r\n");
      out.write("\t\t\t\t<li><a href=\"winnerList.do?type=2\">이벤트 당첨자</a></li>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<!-- -------------------------------- 이벤트 -------------------------------- -->\r\n");
 ...
 for(Event e: eList){ 
      ...
      out.write("\t   \t\t\t\t\t\t\t\t\t\t\t<img src=\"");
      out.print(src);
      out.write("\" width=\"374 !important\" height=\"308 !important\">\r\n");
      out.write("   \t\t\t\t\t\t\t\t\t\t\t");
...
if(currentPage > 5) {
      ...
      out.print(request.getContextPath());
      out.write("/event/eventList.do?type=");
      out.print(eventType);
      out.write("&cp=1\">&lt;&lt;</a></li>\r\n");
      out.write("\t\t\t\t\t\t<li class=\"btn\"><a href=\"");
      out.print(request.getContextPath());
