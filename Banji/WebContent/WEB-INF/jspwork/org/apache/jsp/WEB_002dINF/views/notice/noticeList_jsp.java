 ...
 * Generated at: 2020-08-06 04:35:07 UTC
...
public final class noticeList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/notice/../common/header.jsp", Long.valueOf(1596684725133L));
  }
...
for(Notice n : nList){ 
      out.write("\n");
      out.write("                    <tr id=\"");
      out.print(n.getBoardNo() );
      out.write("\">\n");
      out.write("                      <td>");
      out.print(n.getRegWriter() );
      out.write("</td>\n");
...
if(str[0].equals(year)&&str[1].equals(month)&&str[2].equals(day)){ 
      out.write("\n");
      out.write("                        <td>");
      out.print(sdf2.format(n.getRegDate()));
      out.write("</td> \n");
      out.write("                        ");
} else{ 
      out.write("\n");
      out.write("                        <td>");
      out.print(sdf1.format(n.getRegDate()));
      out.write("</td>\n");
      out.write("                        ");
} 
      out.write("\n");
 ...
 if(currentPage > 10) { 
      ...
      out.print(request.getContextPath());
      out.write("/notice/list.do?&cp=1\">&lt;&lt;</a>\n");
      out.write("                    </li>\n");
      out.write("                 \n");
...
if (p== currentPage) {
 ...
 if((next < maxPage)) {
      ...
      out.write("              <button type=\"button\" id=\"close\" class=\"btn btn-secondary\" data-dismiss=\"modal\" onclick=\"ok();\">Close</button>\n");
