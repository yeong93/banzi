 ...
 * Generated at: 2020-08-03 04:45:11 UTC
...
public final class secession_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser == null) {
      ...
      out.write("\t\t\t\t\t\t\t<form method=\"POST\" action=\"secession.do\"\r\n");
      out.write("\t\t\t\t\t\t\t\tonsubmit=\"return validate();\" class=\"form-horizontal\"\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"form\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- 현재 아이디 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tname=\"pwd\" placeholder=\"비밀번호\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<hr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("제 11 조 (회원 탈퇴 및 자격 상실)\r\n");
      out.write("\r\n");
      out.write("① 회원은 회사에 언제든지 회원 탈퇴를 요청할 수 있으며 회사는 요청을 받은 즉시 해당 회원의 회원 탈퇴를 위한 절차를 밟아 개인정보취급방침에 따라 회원 등록을 말소합니다.\r\n");
      out.write("\r\n");
      out.write("② 회사의 모든 서비스에서 이용중인 서비스의 기간이 남아있는 회원이 탈퇴 요청하였을 경우 회원탈퇴로 인한 서비스의 중지 또는 피해는 회원탈퇴 이용자에게 있습니다.\r\n");
      out.write("\r\n");
      out.write("③ 회원이 서비스 이용에 있어서 본 양관 제 제 10조 내용을 위반하거나, 다음 각 호의 사유에 해당하는 경우 회사는 직권으로 회원자격 상실 및 회원탈퇴의 조치를 할 수 있습니다.\r\n");
      out.write("\r\n");
      out.write("1. 다른 사람의 명의를 사용하여 가입 신청한 경우\r\n");
      out.write("\r\n");
      out.write("2. 신청 시 필수 작성 사항을 허위로 기재한 경우\r\n");
      out.write("\r\n");
      out.write("3. 관계법령의 위반을 목적으로 신청하거나 그러한 행위를 하는 경우\r\n");
      out.write("\r\n");
      out.write("4. 사회의 안녕질서 또는 미풍양속을 저해할 목적으로 신청하거나 그러한 행위를 하는 경우\r\n");
      out.write("\r\n");
      out.write("5. 다른 사람의 회사 서비스 이용을 방해하거나 그 정보를 도용하는 등 전자거래질서를 위협하는 경우\r\n");
      out.write("\r\n");
      out.write("6. 관계 법령 위배와 본 약관이 금지하는 행위를 하는 회원 경우\r\n");
      out.write("\r\n");
      out.write("④ 회사가 직권으로 화원탈퇴 처리를 하고자 하는 경우에는 말소 전에 회원에게 소명의 기회를 부여합니다.\r\n");
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-primary btn-lg btn-block\" type=\"submit\" id=\"mypage-btn\">탈퇴</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
