 ...
 * Generated at: 2020-08-05 06:57:00 UTC
...
public final class winnerList_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser != null && loginUser.getUserId().equals("master")){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><button type=\"button\" class=\"btn btn-outline-secondary\" onclick=\"location.href='changeWinner.do?type=");
      out.print(eventType);
      out.write("&cp=");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td><button type=\"button\" class=\"btn btn-outline-secondary\" onclick=\"location.href='deleteWinner.do?type=");
      out.print(eventType);
      out.write("&cp=");
      out.print(currentPage);
      out.write("&no=");
...
if(next < maxPage) {
      ...
      out.write("\t\t\t\t\tSwal.fire({\r\n");
      out.write("\t\t\t\t\t\t  title: '<strong>'+event.eventTitle+' 당첨자 발표</strong><br><br>',\r\n");
      out.write("\t\t\t\t\t\t  html:\r\n");
      out.write("\t\t\t\t\t\t\t  '<h5>' + event.eventWin + '</h5>',\r\n");
