 ...
 * Generated at: 2020-08-06 06:02:14 UTC
...
public final class winnerList_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser != null && loginUser.getUserId().equals("master")){ 
      ...
      out.write("\t\t\t\t<li><a href=\"pastList.do?type=2\">종료된 이벤트</a></li>\r\n");
      out.write("\t\t\t\t<li class=\"on\"><a href=\"winnerList.do?type=2\">이벤트 당첨자</a></li>\r\n");
      out.write("\t\t\t</ul>\r\n");
      out.write("\r\n");
      out.write("\t\t\t<!-- -------------------------------- 이벤트 -------------------------------- -->\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<div class=\"eventList mx-auto\">\r\n");
      out.write("\t\t\t\t<table class=\"table mx-auto text-center\" id=\"list-table\">\r\n");
      out.write("\t\t\t\t\t<thead class=\"thead-light\">\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th>글 번호</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th>해당 이벤트 번호</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th>해당 이벤트 제목</th>\r\n");
      out.write("\t\t\t\t\t\t\t<th>해당 이벤트 기간</th>\r\n");
      out.write("\t\t\t\t\t\t\t");
 if(loginUser != null && loginUser.getUserId().equals("master")){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<th>글 수정</th>\r\n");
      out.write("\t\t\t\t\t\t\t");
 }
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</tr>\r\n");
 ...
 if(wList.isEmpty()){ 
      ...
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th colspan=\"2\">존재하는 이벤트 당첨자 발표 글이 없습니다.</th>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t");
 }else { 
 ...
 for(Event e: wList){ 
      ...
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td id=\"td1\">");
      out.print(e.getEventWinNo());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td id=\"td2\"><strong>");
 ...
 if(loginUser != null && loginUser.getUserId().equals("master")){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td><button type=\"button\" class=\"btn btn-outline-secondary\" onclick=\"location.href='changeWinnerForm.do?type=");
      out.print(eventType);
      out.write("&cp=");
...
if(next < maxPage) {
      ...
      out.write("\t<script>\r\n");
      out.write("\tvar $td = $(\"#td1, #td2, #td3, #td4\")\r\n");
      out.write("\t$td.on(\"click\", function(){\r\n");
      out.write("\t\tvar boardNo = $(this).parent().children().eq(1).text();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t\t$.ajax({\r\n");
      out.write("\t\t\turl : \"winnerView.do\",\r\n");
      out.write("\t\t\tdata : {\"no\" : boardNo, \"type\" : ");
      out.print(eventType);
      out.write(", \"cp\" : ");
      out.print(currentPage);
      out.write("},\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\tif(event != null){\r\n");
      out.write("\t\t\t\t\tSwal.fire({\r\n");
      out.write("\t\t\t\t\t\t  title: '<strong>'+event.eventTitle+'</strong>',\r\n");
      out.write("\t\t\t\t\t\t  html:\r\n");
      out.write("\t\t\t\t\t\t\t  '<h4>당첨자 발표</h4><hr>'+\r\n");
      out.write("\t\t\t\t\t\t\t  '<br><h5>' + event.eventWin + '</h5><br>' +\r\n");
      out.write("\t\t\t\t\t\t\t  '<h5> 자세한 사항은 이메일로 발송드렸습니다.</h5><br>',\r\n");
      out.write("\t\t\t\t\t\t  showCloseButton: true\r\n");
      out.write("\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\tSwal.fire(\"조회된 결과가 없습니다.\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
