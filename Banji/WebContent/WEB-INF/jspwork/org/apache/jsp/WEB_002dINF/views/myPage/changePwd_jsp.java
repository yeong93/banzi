 ...
 * Generated at: 2020-07-29 06:58:53 UTC
...
public final class changePwd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/myPage/../common/header.jsp", Long.valueOf(1596005407443L));
 ...
 if(loginUser == null) {
      ...
      out.write("\t\t\t\t\t\t<h3 id=\"title\">비밀번호 수정</h3>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<form method=\"POST\" action=\"changePwd.do\" onsubmit=\"return validate();\" class=\"form-horizontal\"\r\n");
      out.write("\t\t\t\t\t\t\t\trole=\"form\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- 현재 비밀번호 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"row mb-5 ml-3 mr-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" id=\"nowPwd\" name=\"nowPwd\" placeholder=\"현재 비밀번호\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<div class=\"row mb-5 ml-3 mr-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" id=\"newPwd\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tname=\"newPwd\" placeholder=\"새 비밀번호\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span id=\"check-area1\"></span><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- 새 비밀번호 확인 -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"row mb-5 ml-3 mr-3\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-md-12\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" id=\"checkPwd\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tname=\"checkPwd\" placeholder=\"새 비밀번호 확인\"><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span id=\"check-area2\"></span><br>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<hr>\r\n");
      ...
      out.write("\t\t\t\"nowPwd\":false,\r\n");
      out.write("\t\t\t\"newPwd\":false,\r\n");
      out.write("\t\t\t\"checkPwd\":false\r\n");
      out.write("\t\t};\r\n");
      out.write("   \r\n");
      out.write("   var $changePwd = $(\"#newPwd, #checkPwd\");\r\n");
      out.write("\t var $newPwd = $(\"newPwd\");\r\n");
      out.write("\t var $checkPwd = $(\"checkPwd\");\r\n");
      out.write("\t\r\n");
      out.write("\t $changePwd.on(\"input\", function(){\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar regExp = /^[A-Za-z0-9]{6,12}$/;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif(!regExp.test($(\"#newPwd\").val())){ \r\n");
      out.write("\t\t\t\t$(\"#check-area1\").text(\"비밀번호 형식이 유효하지 않습니다.\").css(\"color\",\"red\");\r\n");
      out.write("\t\t\t\tpwdCheck.newPwd = false;\r\n");
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t\t$(\"#check-area1\").text(\"유효한 비밀번호 형식입니다.\").css(\"color\",\"green\");\r\n");
      out.write("\t\t\t\tpwdCheck.newPwd = true;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif(!pwdCheck.newPwd && $(\"#checkPwd\").val().length > 0){\r\n");
      out.write("\t\t\tswal(\"유효한 비밀번호를 작성해 주세요.\");\r\n");
      out.write("\t\t\t$(\"#checkPwd\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#newPwd\").focus();\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t}else if(pwdCheck.newPwd && $(\"#checkPwd\").val().length > 0){\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tif($(\"#newPwd\").val().trim() != $(\"#checkPwd\").val().trim()){\r\n");
      ...
      out.write("\t   \r\n");
      out.write("\t   if($(\"#nowPwd\").val().trim() == $(\"#newPwd\").val().trim()){\r\n");
      out.write("\t\t\t  swal({\r\n");
      out.write("\t\t\t\t    icon: \"warning\", \r\n");
      out.write("\t\t\t\t    title: \"새 비밀번호 재입력\",\r\n");
      out.write("\t\t\t\t    text : \"현재 비밀번호와 다른 비밀번호를 입력해주세요.\"\r\n");
      out.write("\t\t\t\t});\r\n");
      ...
      out.write("\t \r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif($(\"#nowPwd\").val().trim() == \"\"){\r\n");
      out.write("\t\t\tswal({\r\n");
      out.write("\t\t\t    icon: \"info\", \r\n");
      out.write("\t\t\t    title: \"현재 비밀번호를 입력해주세요.\"\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$(\"#nowPwd\").focus();\r\n");
      out.write("\t\t\treturn false; \r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif($(\"#newPwd\").val().trim() == \"\"){\r\n");
      out.write("\t\t\tswal({\r\n");
      out.write("\t\t\t    icon: \"info\", \r\n");
      out.write("\t\t\t    title: \"새 비밀번호를 입력해주세요.\"\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t$(\"#newPwd\").focus();\r\n");
      out.write("\t\t\treturn false; \r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tif($(\"#checkPwd\").val().trim() == \"\"){\r\n");
      out.write("\t\t\tswal({\r\n");
      out.write("\t\t\t    icon: \"info\", \r\n");
      out.write("\t\t\t    title: \"새 비밀번호 확인을 입력해주세요.\"\r\n");
      out.write("\t\t\t});\r\n");
      ...
      out.write("\t\t\t\tcase \"newPwd\" : msg=\"새 비밀번호가\";  break;\r\n");
      out.write("\t\t\t\tcase \"checkPwd\" : msg=\"새 비밀번호가\";  break;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\tswal({\r\n");
      out.write("\t\t\t\t    icon: \"info\", \r\n");
