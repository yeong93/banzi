 ...
 * Generated at: 2020-08-06 06:26:45 UTC
...
public final class changeWinner_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser != null && loginUser.getUserId().equals("master")){ 
      ...
      out.write("\t\t\t<h1 class=\"type1\">이벤트 당첨자 발표</h1>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\t<form class=\"eventList mx-auto\" method=\"POST\" action=\"");
      out.print(request.getContextPath());
      out.write("/event/changeWinner.do?type=");
      out.print(type);
      out.write("&cp=");
      out.print(cp);
      out.write("&no=");
      ...
      out.write("\t\t\t\t  <tr><td colspan=\"3\" class=\"text-center\">'삭제'하려면 모든 글을 지워주세요!!!</td></tr>\r\n");
      out.write("\t\t\t\t\t<tr><td colspan=\"3\">이벤트 번호 : ");
      out.print(event.getEventNo() );
      out.write("</td></tr>\r\n");
      out.write("\t\t\t\t  \t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t<button type=\"submit\" class=\"btn btn-primary btn-warning\" id=\"insertBtn\">글 수정</button>\r\n");
      out.write("\t\t\t\t\t<a href=\"winnerList.do?&type=");
      out.print(type);
      out.write("&cp=");
      out.print(cp);
      out.write("\" class=\"btn btn-primary btn-warning\" id=\"listBtn\">목록으로</a>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t\t\tif ($(\"#content\").text().trim().length == 0) {\r\n");
      out.write("\t\t\t\tswal({\r\n");
      out.write("\t\t\t\t    icon: \"info\", \r\n");
      out.write("\t\t\t\t    title: \"내용을 입력해 주세요.\"\r\n");
      out.write("\t\t\t\t});\r\n");
