 ...
 * Generated at: 2020-08-06 02:21:09 UTC
...
public final class informationList_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(loginUser != null && loginUser.getUserId().equals("master")){ 
      ...
      out.write("  \t<div id=\"image_area\" class=\"mx-auto\">\r\n");
      out.write("  \t<img src=\"");
      out.print(request.getContextPath());
      out.write("/resources/img/information_banner.jpg\">\r\n");
      out.write("  \t</div>\r\n");
      out.write("       <div class=\"form-group\">\r\n");
      out.write("       <div id=\"selectArea\" class=\"mx-auto\">\r\n");
      out.write("        <label for=\"inputQuestion\" class=\"col-lg-2 control-label\"></label>\r\n");
      ...
      out.write("\t\t\t\t\tvar click = $(\"#category option:selected\").val();\r\n");
      out.write("\t\t\t\t\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/information/list.do?type=2&category=\"+click;\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t                </thead>\r\n");
      out.write("\t\t\t\t\t <tbody>\r\n");
      out.write("\t                <!-- 조회되는 값이 없어도 쿼리문은 성공함, 에러 없이 비어있는 arrayList가 반환됨 -->\r\n");
      out.write("\t                \t");
 if(bList.isEmpty()) { 
      out.write("\r\n");
 ...
 for(Information information : bList)  {
  ...
  if(loginUser != null && loginUser.getUserGrade().trim().equals("editor")) {
      ...
      out.write("\t        \r\n");
      out.write("\t        <!-- 페이징바 -->\r\n");
      out.write("\t        <div style=\"clear : both\" id=\"page\">\r\n");
      out.write("\t        \t<ul class=\"pagination\">\r\n");
      out.write("\t        \t\t");
 if(currentPage > 10) { 
      out.write("\r\n");
      out.write("\t        \t\t\t<!-- 맨 처음 페이지로 이동[<<] -->\r\n");
      out.write("\t        \t\t\t<li>\t        \t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- & : 파라미터 이어서 추가 -->\r\n");
      out.write("\t        \t\t\t\t<a class=\"page-link\" href=\"");
      out.print(request.getContextPath());
      out.write("/information/list.do?type=");
      out.print(boardType);
      out.write("&cp=1&category=");
      out.print(category );
      out.write("\">&lt;&lt;</a>\r\n");
      out.write("\t        \t\t\t</li>\r\n");
 ...
 for(int p = startPage; p<=endPage; p++)  {
      out.write("\r\n");
      out.write("\t        \t\t\t<!--  내가 보고 있는 페이지가 p와 같은 숫자일 때 -->\r\n");
      out.write("\t        \t\t\t");
if(p == currentPage)  { 
      out.write("\r\n");
      out.write("\t        \t\t\t<!--  a태그의 href 속성을 설정하지 않음, 클릭 안됨 -->\r\n");
 ...
 if((next < maxPage))  { 
      ...
      out.write("\t\t\tvar infoBoardNo = $(this).parent().children().eq(0).text();\r\n");
      out.write("\t\t\t// location.href : 요청을 보내서 이동하는 jquery 내부 객체\r\n");
      out.write("\t\t\tlocation.href =\r\n");
      out.write("\t\t\t\"");
      out.print(request.getContextPath());
      out.write("/information/view.do?type=");
      out.print(boardType);
      out.write("&cp=");
      out.print(currentPage);
      out.write("&category=");
      out.print(category);
      out.write("&no=\" + infoBoardNo;\r\n");
      out.write("\t\t// .으로 메소드 체이닝\r\n");
      out.write("\t\t}).on(\"mouseenter\", function() {\r\n");
      out.write("\t\t\t// cursor를 pointer로 변경시킴\r\n");
