 ...
 * Generated at: 2020-08-06 07:12:03 UTC
...
public final class qnaList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/qna/../common/header.jsp", Long.valueOf(1596684725133L));
  }
 ...
 SimpleDateFormat sdf2 = new SimpleDateFormat(pattern2);
      ...
      out.write("background-color: #81F7D8;\n");
      out.write("}\n");
      out.write("  </style>\n");
      out.write("  \n");
      out.write("</head>\n");
 ...
 if(loginUser != null && loginUser.getUserId().equals("master")){ 
      ...
      out.write("\t              <a class=\"dropdown-item\" href=\"");
      out.print(request.getContextPath());
      out.write("/masterPage/userAuthList.do\">회원 등급 부여</a>\n");
      out.write("\t              <a class=\"dropdown-item\" href=\"");
      out.print(request.getContextPath());
      out.write("/masterPage/stillList.do\">당첨자 미발표 이벤트</a>\n");
      out.write("            \t</div>\n");
      out.write("\t\t\t\t\t\t");
 }else { 
      out.write("\n");
...
if(str[0].equals(year)&&str[1].equals(month)&&str[2].equals(day)){ 
      out.write("\n");
      out.write("                        <td>");
      out.print(sdf2.format(q.getRegDate()));
      out.write("</td> \n");
      out.write("                        ");
} else{ 
      out.write("\n");
      out.write("                        <td>");
      out.print(sdf1.format(q.getRegDate()));
      out.write("</td>\n");
      out.write("                        ");
} 
      out.write("\n");
...
if (p== currentPage) {
 ...
 if((next <= maxPage)) {
      ...
      out.write("\t\t\t        <button type=\"button\" class=\"btn btn-success\" data-dismiss=\"modal\" onclick=\"ok();\">확인</button>\n");
      out.write("\t\t\t      </div>\n");
      out.write("\t\t\t    </div>\n");
      out.write("\t\t\t  </div>\n");
      out.write("\t\t\t</div>\n");
 ...
 if(tempUser != null){
      ...
      out.write("    \t\t  if(map.qna.regWriter == userNick){\n");
      out.write("    \t\t\t  $(\".bt\").remove();\n");
      out.write("    \t\t\t  $(\".modal-footer\").prepend(\"<div class ='btn btn-primary bt' data-dismiss='modal' onclick='deleteQna();'>삭제\");\n");
      out.write("    \t\t\t  $(\".modal-footer\").prepend(\"<div class ='btn btn-primary bt' data-dismiss='modal' onclick='updateQna();'>수정\");\n");
      out.write("    \t\t  }\n");
      ...
      out.write("    \t\t\t   $div = $(\"<div>\").addClass(\"nick_box\").text(\"작성자 : \" + map.rList[i].regWriter);\n");
      out.write("    \t\t\t   $div2 = $(\"<div>\").addClass(\"nick_box\").attr(\"id\",\"date\").text(\"작성일 : \" + map.rList[i].regDate);\n");
      out.write("    \t\t\t   $p2 = $(\"<p>\").addClass(\"reply_content\").html(map.rList[i].content);\n");
      out.write("             $(\"#content\").append($div,$div2, $p2);\n");
      ...
      out.write(" \t\t\t         $(\"#content\").append($deleteReply);\n");
      out.write("    \t\t\t   }\n");
      out.write("     \t\t\t  }\n");
      out.write("    \t\t  }\n");
      out.write("     \t\t  if(map.userGrade.trim() == \"veterinarian\" && map.userGrade.trim() == \"veterinarian\"){\n");
      ...
      out.write("                 /* var $showUpdate = $(\"<button>\").addClass(\"btn btn-primary btn-sm ml-1\").text(\"수정\").attr(\"onclick\",\"showUpdateReply(this, \"+map.rList[i].replyNo+\");\"); */\n");
      out.write("                 var $deleteReply = $(\"<button>\").addClass(\"btn btn-primary btn-sm ml-1\").text(\"삭제\").attr(\"onclick\",\"showDeleteReply(\"+map.rList[i].replyNo+\");\");\n");
      out.write("                 $(\"#content\").append($div,$div2, $p2, $deleteReply);\n");
      out.write("              }else{\n");
      out.write("            \t   $(\"#content\").append($div,$div2, $p2);\n");
      out.write("              }\n");
      out.write("            }\n");
      ...
      out.write("    \tvar boardNo = $(\"[type='hidden']\").attr(\"class\");\n");
      out.write("     \tif(userNick == $(\"#info\").attr(\"class\")){\n");
      ...
      out.write("     \t}\n");
      out.write("    };\n");
      out.write("    function deleteQna(){\n");
      out.write("    \tif(confirm(\"해당 글을 삭제 하시겠습니까?\")){\n");
      out.write("    \t var boardNo = $(\"[type='hidden']\").attr(\"class\");\n");
      out.write("    \t location.href=\"delete.do?no=\"+boardNo;\n");
      out.write("    \t}\n");
      out.write("    }; \n");
      ...
      out.write("    \t  $('#list-table tr').mouseover(function(){\n");
      out.write("    \t\t  $(this).addClass('changeColor');\n");
      out.write("\t\t}).mouseout(function() {\n");
      out.write("\t\t\t   $(this).removeClass('changeColor');\n");
      out.write("\t\t});\n");
      out.write("\t\t}\n");
      out.write("\n");
      out.write("  </script>\n");
