			...
			<ul class="eventList mx-auto">
				...
				<div class="text-center">
					<% if(loginUser != null && loginUser.getUserId().equals("master")){ %>
						<button type="submit" class="btn btn-primary btn-warning" id="delBtn">글 삭제</button>
						<button type="button" class="btn btn-primary btn-warning" id="upBtn">글 수정</button>
					<% } %>
