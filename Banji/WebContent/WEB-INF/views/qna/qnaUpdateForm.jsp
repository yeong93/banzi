...
<body>
    ...
    <div class="container my-5">
      ...
      <form action="<%=request.getContextPath()%>/qna/update.do?type=<%=qna.getBoardType()%>&cp=<%=cp%>&no=<%=qna.getBoardNo()%>" method="post" 
          enctype="multipart/form-data" role="form" onsubmit="return validate();">

        <div class="form-inline mb-2">
          <label class="input-group-addon mr-3 insert-label">제목</label> 
          <input type="text" class="form-control" id="title" name="title" size="70" value="<%=qna.getTitle()%>">
        </div>
...
<!--         <div class="form-inline mb-2">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="content" name="content"
            rows="10" style="resize: none;"><%=qna.getContent()%></textarea>
        </div>
